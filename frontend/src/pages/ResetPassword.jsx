...
const ResetPassword = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white p-4 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 left-10 w-80 h-80 bg-gradient-to-br from-emerald-50/50 to-white rounded-full mix-blend-multiply opacity-70 blur-xl animate-pulse"></div>
          <div className="absolute bottom-20 right-10 w-80 h-80 bg-gradient-to-tl from-emerald-50/50 to-white rounded-full mix-blend-multiply opacity-70 blur-xl animate-pulse delay-1000"></div>
        </div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white p-4 overflow-hidden">
      {/* Decorative background elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-10 left-10 w-72 h-72 bg-gradient-to-br from-gray-50 to-white rounded-full mix-blend-multiply opacity-70 blur-xl animate-pulse"></div>
        <div className="absolute bottom-10 right-10 w-72 h-72 bg-gradient-to-tr from-gray-50 to-white rounded-full mix-blend-multiply opacity-70 blur-xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-gradient-to-r from-gray-50 to-white rounded-full mix-blend-multiply opacity-50 blur-xl animate-pulse delay-500"></div>
      </div>
